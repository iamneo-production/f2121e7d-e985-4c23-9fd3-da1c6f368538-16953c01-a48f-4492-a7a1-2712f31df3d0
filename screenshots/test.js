...
(async () => {
  ...
  await page.goto('https://8080-fadcbeeabebaffeaeabcdffcafaafdfd.project.examly.io');
  ...
  await page1.goto('https://8081-fadcbeeabebaffeaeabcdffcafaafdfd.project.examly.io');
